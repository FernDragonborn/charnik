...
> Findings from a read-only review of the character builder. Nothing here is fixed. Triaged items
> belong in `docs/plan.md`; this file is the raw sweep and is deleted once its contents have moved
> there or into code.
