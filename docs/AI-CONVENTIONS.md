...
- **`charnik.config.json`** — app configuration (which roots are enabled; and, in the app repo,
  `contentRepo` — where THIS machine keeps the content clone) — not a description of data.
